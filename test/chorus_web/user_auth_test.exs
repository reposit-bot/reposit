defmodule ChorusWeb.UserAuthTest do
  use ChorusWeb.ConnCase, async: true

  alias Chorus.Accounts
  alias Chorus.Accounts.Scope
  alias ChorusWeb.UserAuth

  import Chorus.AccountsFixtures

  @remember_me_cookie "_chorus_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ChorusWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
