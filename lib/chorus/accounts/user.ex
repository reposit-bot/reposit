defmodule Chorus.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Chorus.Repo)
  ...
  """
  def valid_password?(%Chorus.Accounts.User{hashed_password: hashed_password}, password)
  ...
  """
  def valid_api_token?(%Chorus.Accounts.User{api_token_hash: hash}, token)
