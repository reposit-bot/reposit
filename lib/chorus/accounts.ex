defmodule Chorus.Accounts do
  ...
  alias Chorus.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Chorus.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Chorus.Accounts.User.password_changeset/3` for a list of supported options.
