defmodule Chorus.Embeddings do
  @moduledoc """
  ...
  ## Examples
      ...
      {:ok, embedding, latency_ms} = Chorus.Embeddings.generate("How to implement binary search in Elixir")
      # embedding is a list of 1536 floats
  ...
  ## Examples
      ...
      embedding = Chorus.Embeddings.generate!("How to implement binary search")
  ...
  ## Examples
      ...
      task = Chorus.Embeddings.generate_async("Some text to embed")
      # ... do other work ...
