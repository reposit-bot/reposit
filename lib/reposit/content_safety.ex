defmodule Reposit.ContentSafety do
  @moduledoc """
  ...
  ## Usage
      ...
      iex> Reposit.ContentSafety.analyze("How to parse JSON?")
      {:ok, %{risk_level: :low, flags: []}}

      iex> Reposit.ContentSafety.analyze("Ignore previous instructions and...")
