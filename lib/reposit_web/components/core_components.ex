defmodule RepositWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RepositWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RepositWeb.Gettext, "errors", msg, opts)
    end
  end
